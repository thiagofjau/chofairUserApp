...
Future<void> resetPassword(String email) async {
  try {
    ...
    const snackBar = SnackBar(
          content: Text('Sucesso! Acesse seu e-mail para redefinir sua senha', textAlign: TextAlign.center),
    ...
    Navigator.pop(context);
    const snackBar = SnackBar(
          content: Text('Digite um e-mail válido', textAlign: TextAlign.center),
